          ...
          <section className="content">
            ...
            <div className="card">
              <div className="card-header row align-items-center">
                <h3 className="card-title col-6">All Products</h3>
                <div className="col-6 text-right">
                    <button type="button" className="btn btn-primary add-btn" data-toggle="modal" data-target="#exampleModalCenter" id="addnewbtn">ADD</button>
                </div>
              </div>
